...
st.markdown(f"""
**AI Model Developer Scientist Dashboard** This system predicts surface/ground water availability by fusing **Historical Data** with **Live Weather API Data** for **{CITY_NAME}**.
""")
